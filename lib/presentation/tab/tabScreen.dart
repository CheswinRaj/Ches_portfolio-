    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ...
          ///page 2
          PageTab2(height: height, width: width),



          ///page 3
          PageTab3(height: height, width: width),

          ///page4
          PageTab4(height: height, width: width),

          PageTab5(height: height, width: width),
        ],
...
class PageTab4 extends StatelessWidget {
  const PageTab4({
    super.key,
...
class PageTab5 extends StatelessWidget {
  PageTab5({
    super.key,
    required this.height,
    required this.width,
